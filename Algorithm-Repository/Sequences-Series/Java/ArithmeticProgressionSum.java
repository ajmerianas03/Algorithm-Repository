...
public class ArithmeticProgressionSum {
    ...
    public static int arithmeticProgressionSum(int a, int d, int n) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Sum of the first " + n + " terms of the arithmetic progression: " + sum);
    }
}
